  ...
  return (
    <>
      <div className="flex h-screen">
        <aside className="w-1/3 flex-col justify-center bg-gray-700 md:w-1/6">
          <h1 className="text-md px-2 py-4 text-center text-xl font-semibold text-white">
            User Auth System
          </h1>
          <hr className="mx-2 border-white" />
          <nav>
            <ul className="flex flex-col justify-center space-y-4 p-2">
              <li className="cursor-pointer rounded-md bg-pink-500 px-4 py-2 text-white shadow-md hover:bg-pink-600 ">
                <p>Profile</p>
              </li>
              <li>
                <button
                  onClick={handleLogout}
                  className="w-full cursor-pointer rounded-md bg-pink-500 px-4 py-2 text-start text-white shadow-md hover:bg-pink-600"
                >
                  Logout
                </button>
              </li>
        ...
        <div className="flex flex-1 flex-col justify-center overflow-hidden">
          <header className="flex h-14 items-center justify-between bg-gray-700 px-2 text-white">
            <input
              type="search"
              placeholder="Type to search..."
              className="m-2 w-2/3 rounded-md bg-gray-700 p-2 focus:outline-none focus:ring focus:ring-pink-500"
            />
          ...
          <main className="flex h-full flex-1 flex-col overflow-y-auto overflow-x-hidden">
            <div className="mx-auto bg-[#E2E8F0] p-6">
              <div>
              ...
              <div className="mt-4 overflow-hidden rounded-md bg-white">
                ...
                <div className="p-4 text-center">
                  <div className="relative z-30 mx-auto -mt-20 h-32 w-32 rounded-full">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="mx-auto my-4 grid max-w-sm grid-cols-3 rounded-md bg-pink-500">
                      <div className="my-2 flex border-spacing-2 flex-row items-center justify-center space-x-2 border-r-[1px] border-black">
                    ...
                    <div className="mt-6">
                      ...
                      <div className="flex flex-row items-center justify-evenly space-x-2">
                        <div className="m flex items-center justify-center gap-3.5">
                          <p>
                            <svg
